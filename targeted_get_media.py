...
def list_new_posts_for_one_blog(session,max_rows,blog_domain):
...
def process_all_posts_media_for_one_blog(blog_domain,max_rows=1000):
    # Connect to DB
    ...
    while len(post_dicts) > 0:
        ...
        post_dicts = list_new_posts_for_one_blog(listing_session,max_rows,blog_domain)
        # Process posts
...
def main():
    ...
    try:
        ...
        process_all_posts_media_for_one_blog(blog_domain=blog_domain)
        # /Program
