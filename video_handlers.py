...
def run_yt_dl(session,post_dict,table_class,download_urls,post_id,extractor_used):
    ...
    logging.debug("Finished downloading "+extractor_used+" embeds")
    return {
        extractor_used:sha512base64_hash,
        media_url:sha512base64_hash,
        }
