...
def debug():
    ...
    vine_restult = video_handlers.handle_video_posts(session,vine_dict)
    ...
    #handle_vimeo_videos(session,vimeo_dict)
    ...
    imgur_result = video_handlers.handle_video_posts(session,imgur_post_dict)
